...
class AdjacencyMatrixTest {
    ...
    void testAddVertexAndEdge() {
        graph.addVertex();
        graph.addEdge(5, 1);
        assertTrue(graph.getNeighbors(5).contains(1));
        assertTrue(graph.getNeighbors(1).contains(5));
    }
    ...
    @Test
    void testAddVertexAndMultipleEdges() {
        graph.addVertex();
        graph.addEdge(5, 1);
        graph.addEdge(5, 2);
        graph.addEdge(5, 3);
        assertTrue(graph.getNeighbors(5).contains(1));
        assertTrue(graph.getNeighbors(5).contains(2));
        assertTrue(graph.getNeighbors(5).contains(3));
        assertTrue(graph.getNeighbors(1).contains(5));
        assertTrue(graph.getNeighbors(2).contains(5));
        assertTrue(graph.getNeighbors(3).contains(5));
    }
