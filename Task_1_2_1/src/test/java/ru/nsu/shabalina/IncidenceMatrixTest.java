...
class IncidenceMatrixTest {
    ...
    void testTopologicalSort1() {
        graph = new IncidenceMatrix(5, 4);
        graph.addEdge(1, 2);
        graph.addEdge(1, 3);
        graph.addEdge(2, 4);
        graph.addEdge(3, 4);
        List<Integer> sortedGraph = graph.topologicalSort();
        assertEquals(List.of(1, 2, 3, 4, 5), sortedGraph);
    }

    @Test
    void testTopologicalSort2() {
        graph = new IncidenceMatrix(8, 7);
        graph.addEdge(1, 2);
        graph.addEdge(1, 3);
        graph.addEdge(2, 4);
        graph.addEdge(3, 4);
        ...
        graph.addEdge(6, 7);
        List<Integer> sortedGraph = graph.topologicalSort();
        assertEquals(List.of(1, 2, 3, 4, 5, 6, 7, 8), sortedGraph);
    }
